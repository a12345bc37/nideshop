  ...
  loginAction() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (think.isEmpty(admin)) {
        return _this.fail(401, '用户名不存在' + think.md5(password + '' + admin.password_salt));
      }

      if (think.md5(password + '' + admin.password_salt) !== admin.password) {
        return _this.fail(400, think.md5(password + '' + admin.password_salt) + ',用户名或密码不正确2，' + admin.password);
      }
